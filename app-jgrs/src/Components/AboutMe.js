...
const AboutMe = () => (
  <section className='aboutMe'>
    ...
    <div className='wrapMedium'>
      <ul className='cards'>
      <li className='cardAtrb'><strong>Não é</strong>Sed et tortor mollis, lacinia turpis in, mollis ipsum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Quisque a scelerisque neque. Vestibulum at mi aliquam, vulputate massa a, condimentum arcu. Donec ac tempus dolor, egestas ornare eros.</li>
      <li className='cardAtrb'><strong>Não é</strong>Sed et tortor mollis, lacinia turpis in, mollis ipsum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Quisque a scelerisque neque. Vestibulum at mi aliquam, vulputate massa a, condimentum arcu. Donec ac tempus dolor, egestas ornare eros.</li>
      <li className='cardAtrb'><strong>Não é</strong>Sed et tortor mollis, lacinia turpis in, mollis ipsum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Quisque a scelerisque neque. Vestibulum at mi aliquam, vulputate massa a, condimentum arcu. Donec ac tempus dolor, egestas ornare eros.</li>
      <li className='cardAtrb'><strong>Não é</strong>Sed et tortor mollis, lacinia turpis in, mollis ipsum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Quisque a scelerisque neque. Vestibulum at mi aliquam, vulputate massa a, condimentum arcu. Donec ac tempus dolor, egestas ornare eros.</li>
      </ul>
      <p>Sed et tortor mollis, lacinia turpis in, mollis ipsum. Vestibulum ante ipsum primis in faucibus orci luctus et <strong>ultrices posuere cubilia curae.</strong></p>
    </div>
  </section>
